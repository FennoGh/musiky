    ...
    return (
        <section className="min-h-screen flex items-center justify-center px-6 md:px-12 lg:px-24 pt-28 pb-16 relative overflow-hidden">
            ...
            <motion.span
                ...
                className="absolute -left-[8%] top-[8%] font-serif text-[42vw] italic font-normal leading-none select-none pointer-events-none"
            >
                M
            </motion.span>
            ...
            <motion.span
                ...
                className="absolute left-6 md:left-12 top-1/2 -translate-y-1/2 font-mono text-[9px] tracking-[0.5em] uppercase text-[#1A1A1A]/[0.08] [writing-mode:vertical-lr] select-none hidden lg:block"
            >
            ...
            <motion.div
                ...
                className="absolute right-24 top-40 w-[1px] h-32 bg-[#1A1A1A]/[0.04] origin-top hidden lg:block"
            />
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                >
                    ...
                    {/* Terms note */}
                    <p className="font-mono text-[10px] tracking-wider text-[#1A1A1A]/60 leading-relaxed">
                        By creating an account you agree to our{' '}
                        <Link href="/terms" className="text-[#1A1A1A]/85 hover:text-[#1A1A1A] underline underline-offset-2 decoration-[#1A1A1A]/30">
                            terms
                        </Link>{' '}
                        and{' '}
                        <Link href="/privacy" className="text-[#1A1A1A]/85 hover:text-[#1A1A1A] underline underline-offset-2 decoration-[#1A1A1A]/30">
                            privacy policy
                        </Link>
                        .
                    </p>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="mt-2 px-8 py-3.5 bg-[#1A1A1A] text-[#F5F1E8] text-sm tracking-wide hover:bg-[#8C7A6B] transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
